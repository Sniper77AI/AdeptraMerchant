...
Backend engine complete and live-verified (37 signals, 2 pillars, 7 artifact
...
### [x] Scoped audit of the rest of v2026-04-08's UCP additions (2026-07-14)
Audited v2026-04-08 delta (see D-091): cart already covered (tightened for
sibling-consistency), `available_instruments` added as advisory, all runtime
items (first-class errors, `intent` context field) out of scope by the
checker/scaffold boundary.
